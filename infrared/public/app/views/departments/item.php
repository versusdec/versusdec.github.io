<?php if ($this->lang == 'en') { ?>
    ...
    <?php if (!empty($department->genimg)) { ?>
        <section>
            <div class="page-img">
                <img src="<?php echo $department->genimg; ?>" alt="">
            </div>
        </section>
    <?php } ?>
    ...
    <section class="s_service-item s_aside">
        <div class="i_aside">
            <h2 class=""><?php echo $department->h1_en ?></h2>

            <article>
                <?php echo $department->description_en ?>
            </article>
...
<?php } else { ?>
    ...
    <section class="s_service-item s_aside">
        <div class="i_aside">
            <h2 class=""><?php echo $department->h1_ru ?></h2>

            <article>
                <?php echo $department->description_ru ?>
            </article>
