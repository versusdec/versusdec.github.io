...
<section class="columns catalog_section">
    ...
    <div class="column_three_quarters ">
        ...
        <div class="catalog_title"><h1><?php echo $category->full_name;?></h1></div>

	    <?php if ($current == 1) { echo $category->small_description;} ?>
        ...
        <div class="category-short-discription">
            <?php if ($current == 1) {echo $category->description;}?>
        </div>
    </div>
</section>
</div>