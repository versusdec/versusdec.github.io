<ul class="breadcrumb">
    ...
    <?php if (isset($category)) { ?>
        <li><a href="/announcements/">Каталог услуг</a></li>
        <li>
...
<div class="page-content side-menu-page">
    <div class="block side-menu-block">
        ...
        <ul class="side-menu">
            ...
            -->
            <?php if (!empty($announcements_categories)) { ?>
                <?php foreach ($announcements_categories as $category_item) { ?>
                    <li>
            ...
            <div class="catalog-handler">
                <div class="catalog-handler__sort-by catalog-handler__item">
                    ...
                    <select name="sort" class="custom-select filter_parameter"
                            data-type="announcement" data-limit="<?php echo $limit; ?>"
                            data-target=".catalog-list" <?php if (isset($category)) {
                        echo 'data-category="' . $category['id'] . '"';
                    } ?>>
                        <option value="id-desc">По убыванию даты добавления</option>
                        <option value="id-asc">По возрастанию даты добавления</option>
                ...
                <div class="catalog-list-wrapper">
                    <?php if (!empty($announcements)) { ?>
                        <div class="catalog-list list-to-handle">
                            ...
                            -->
                            <?php foreach ($announcements as $announcement_item) { ?>
                                <?php include $WIDGETS . 'announcement_item.php'; ?>
                            <?php } ?>
                        </div>
                        <div class="button button-lg button-white catalog-load-more"
                             data-type="announcement" data-current="1" data-limit="<?php echo $limit; ?>"
                             data-target=".catalog-list" <?php if (isset($category)) {
                            echo 'data-category="' . $category['id'] . '"';
                        } ?>>
                            Показать еще
