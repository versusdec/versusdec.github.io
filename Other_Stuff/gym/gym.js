...
(0, _jquery2.default)('.header_menu_btn').click(function () {
    (0, _jquery2.default)('.header_menu').toggleClass('activate_header_menu');
});
...
var grid = document.querySelector('.we_offer_wrapper');
...
var target = document.querySelector('.slider_wrapper');
var slides = document.querySelectorAll('.slide');
var timer = null;
var slideIndex = 0;

slides.forEach(function (slide, i) {
    var target = document.querySelector('.slider_dots');
