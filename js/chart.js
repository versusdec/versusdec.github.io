define(['chartjs', 'chart_plugin'],  function (Chart, ChartDataLabels) {


    class OuterLabels {
        init(chartInstance) {
            this.chart = chartInstance;
            this.ctx = chartInstance.$context;
        }
        ...
        configure(override) {
            ...
            this.config = {
                offset: 3,
                padding: 2,
                fontNormalColor: Chart.defaults.color,
                fontNormalSize: 12,
                fontNormalFamily: "sans-serif",
                fontBoldColor: Chart.defaults.color,
                fontBoldSize: 14,
                fontBoldFamily: "sans-serif",
                fontNormalStyle: 400,
                fontBoldStyle: 600,
                twoLines: false,
                debug: false,
        ...
        resolveDataset(dataset, chartInstance) {
        ...
        drawLabels() {
            for (let i = 0; i < this.length; ++i) {
                if (this.config.twoLines) {
                    this.drawDoubleLine(this.meta.data[i], this[i]);
                } else {
                    this.drawSingleLine(this.meta.data[i], this[i]);
                }
            }
    ...
    Chart.register({
        ...
        afterDatasetsDraw: chartInstance => {
            ...
            chartInstance.outerLabels.resolveDataset(dataset, chartInstance);
            chartInstance.outerLabels.drawLabels(dataset, chartInstance);
        },
    });


    Chart.DataLabels = ChartDataLabels
    return Chart
})